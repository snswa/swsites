...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.occupation'
        db.add_column('sw_profile', 'occupation', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Profile.occupation_privacy'
        db.add_column('sw_profile', 'occupation_privacy', self.gf('django.db.models.fields.CharField')(default='C', max_length=1), keep_default=False)

        # Adding field 'Profile.employer'
        db.add_column('sw_profile', 'employer', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Profile.employer_privacy'
        db.add_column('sw_profile', 'employer_privacy', self.gf('django.db.models.fields.CharField')(default='C', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.occupation'
        db.delete_column('sw_profile', 'occupation')

        # Deleting field 'Profile.occupation_privacy'
        db.delete_column('sw_profile', 'occupation_privacy')

        # Deleting field 'Profile.employer'
        db.delete_column('sw_profile', 'employer')

        # Deleting field 'Profile.employer_privacy'
        db.delete_column('sw_profile', 'employer_privacy')
