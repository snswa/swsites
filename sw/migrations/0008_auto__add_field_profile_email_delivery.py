...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.email_delivery'
        db.add_column('sw_profile', 'email_delivery', self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Profile.email_delivery'
        db.delete_column('sw_profile', 'email_delivery')
    ...
    models = {
        ...
        'sw.profile': {
            ...
            'email_delivery': ('django.db.models.fields.CharField', [], {'default': "'00/48'", 'max_length': '5', 'blank': 'True'}),
