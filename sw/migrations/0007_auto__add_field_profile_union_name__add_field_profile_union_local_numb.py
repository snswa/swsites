...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.union_name'
        db.add_column('sw_profile', 'union_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Profile.union_local_number'
        db.add_column('sw_profile', 'union_local_number', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Profile.union_privacy'
        db.add_column('sw_profile', 'union_privacy', self.gf('django.db.models.fields.CharField')(default='C', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.union_name'
        db.delete_column('sw_profile', 'union_name')

        # Deleting field 'Profile.union_local_number'
        db.delete_column('sw_profile', 'union_local_number')

        # Deleting field 'Profile.union_privacy'
        db.delete_column('sw_profile', 'union_privacy')
    ...
    models = {
        ...
        'sw.interest': {
            'Meta': {'ordering': "('-order', 'name')", 'object_name': 'Interest'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        'sw.profile': {
            ...
            'union_local_number': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'union_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'union_privacy': ('django.db.models.fields.CharField', [], {'default': "'C'", 'max_length': '1'}),
