...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sw_profile', (
            ...
            ('phone_notes', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('bio', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('sw', ['Profile'])


    def backwards(self, orm):
        
        # Deleting model 'Profile'
        db.delete_table('sw_profile')
    ...
    models = {
        ...
        'sw.profile': {
            ...
            'phone_notes': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
