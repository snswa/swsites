...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table('zipcodes_county')
    ...
    models = {
        ...
        'zipcodes.county': {
            ...
            'teams': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['teams.Team']", 'symmetrical': 'False'})
        },
        'zipcodes.zipcode': {
