...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PostsForFeed'
        db.create_table('cmsplugin_postsforfeed', (
        ...
        db.send_create_signal('planetcms', ['PostsForFeed'])


    def backwards(self, orm):
        
        # Deleting model 'PostsForFeed'
        db.delete_table('cmsplugin_postsforfeed')
    ...
    models = {
        ...
        'planetcms.postsforfeed': {
            'Meta': {'object_name': 'PostsForFeed', 'db_table': "'cmsplugin_postsforfeed'", '_ormbases': ['cms.CMSPlugin']},
